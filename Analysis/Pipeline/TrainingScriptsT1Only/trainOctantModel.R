...
scriptsDirectory <- paste0( baseDirectory, 'ScriptsT1Only/' )
...
weighted_loss <- weighted_categorical_crossentropy( weights = c( 1, 1000 ) ) # Round1
dice_loss <- multilabel_dice_coefficient( smoothingFactor = 1.0 ) # Round 2
# dice_loss <- multilabel_dice_coefficient( smoothingFactor = 0.1 )
# dice_loss <- multilabel_dice_coefficient( smoothingFactor = 0.5 )
